...
const FloatingSocials: React.FC = () => {
    return (
        <div className="floating-socials">
            <SocialLink href="https://www.instagram.com/cfs9gym" icon={<InstagramIcon />} label="Instagram" />
            <SocialLink href="https://www.facebook.com/cfs9gym" icon={<FacebookIcon />} label="Facebook" />
            <SocialLink href="https://www.youtube.com/@cfs9gym" icon={<YouTubeIcon />} label="YouTube" />
            <SocialLink href="https://wa.me/919133333359" icon={<WhatsAppIcon />} label="WhatsApp" />
            <SocialLink href="https://maps.google.com/?q=CFS9+Gym" icon={<LocationIcon />} label="Location" />
        </div>
    );
};
