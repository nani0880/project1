        ...
        <footer className="footer">
            <div className="site-container footer__grid">
                <div className="footer__brand">
                    <Logo />
                    <p className="footer__tagline">Train. Transform. Triumph.</p>
                ...
                <div>
                    ...
                    <div className="footer__list">
                        <a href="https://maps.google.com/?q=CFS+Gym+Jubilee+Hills+Hyderabad" target="_blank" rel="noopener noreferrer">
                ...
                <div>
                    ...
                    <div className="footer__list">
                        <div className="footer__hours-item">
                            <span className="footer__hours-day">Mon - Sat</span>
                            <span className="footer__hours-time">5:30 AM – 10:00 PM</span>
                        </div>
                        <div className="footer__hours-item">
                            <span className="footer__hours-day">Sunday</span>
                            <span className="footer__hours-time">5:30 AM – 2:00 PM</span>
                        </div>
                    </div>
                </div>
            </div>
